\hypertarget{stm32f1xx__hal__i2s_8c}{}\doxysection{STM32\+F1xx\+\_\+\+HAL\+\_\+\+Driver/\+Src/stm32f1xx\+\_\+hal\+\_\+i2s.c File Reference}
\label{stm32f1xx__hal__i2s_8c}\index{STM32F1xx\_HAL\_Driver/Src/stm32f1xx\_hal\_i2s.c@{STM32F1xx\_HAL\_Driver/Src/stm32f1xx\_hal\_i2s.c}}
...
Include dependency graph for stm32f1xx\+\_\+hal\+\_\+i2s.\+c\+:
% FIG 0
  ...
  *** I2S Workarounds linked to Silicon Limitation ***
  ...
  [..]
      (@) Only the 16-bit mode with no data extension can be used when the I2S
          is in Master and used the PCM long synchronization mode.\end{DoxyVerb}
