...
//user defined colors
#define ST7735_GRAY ST7735_COLOR565(160,160,160)
...
//
void ST7735_WriteJustifyString(uint16_t row, const char* str, FontDef font, uint16_t color, uint16_t bgcolor, JustifyDef justify);
